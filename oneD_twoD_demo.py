...
class DemoWindow(QMainWindow):
    ...
    def _build_tab_1d(self):
        ...
        self.s_ofx = FloatSlider(-2.0, 2.0, 0.1, self.defaults["offset_factor_x"])
        self.s_mfx = FloatSlider(-2.0, 2.0, 0.1, self.defaults["mid_factor_x"])
        self.s_mfy = FloatSlider(-2.0, 2.0, 0.1, self.defaults["mid_factor_y"])
        ...
        f3 = QFormLayout(g_pf)
        self.s_pf0 = FloatSlider(0.01, 3.0, 0.1, self.defaults["period_factors"][0])
        self.s_pf1 = FloatSlider(0.01, 3.0, 0.1, self.defaults["period_factors"][1])
        self.s_pf2 = FloatSlider(0.01, 3.0, 0.1, self.defaults["period_factors"][2])
        ...
        f4 = QFormLayout(g_my)
        self.s_my0 = FloatSlider(0.0, 1.0, 0.1, self.defaults["min_y_positions"][0])
        self.s_my1 = FloatSlider(0.0, 1.0, 0.1, self.defaults["min_y_positions"][1])
        self.s_my2 = FloatSlider(0.0, 1.0, 0.1, self.defaults["min_y_positions"][2])
        self.s_my3 = FloatSlider(0.0, 1.0, 0.1, self.defaults["min_y_positions"][3])
    ...
    def _build_tab_2d(self):
        ...
        f2 = QFormLayout(g2_f)
        self.s_tfa = FloatSlider(0.0, 1.0, 0.1, self.defaults["thickness_factor"][0])
        self.s_tfb = FloatSlider(0.0, 1.0, 0.1, self.defaults["thickness_factor"][1])
        self.s_tfc = FloatSlider(0.0, 1.0, 0.1, self.defaults["thickness_factor"][2])
        ...
        self.s_tf2a = FloatSlider(0.0, 1.0, 0.1, self.defaults["thickness_factor2"][0])
        self.s_tf2b = FloatSlider(0.0, 1.0, 0.1, self.defaults["thickness_factor2"][1])
        self.s_tf2c = FloatSlider(0.0, 1.0, 0.1, self.defaults["thickness_factor2"][2])
